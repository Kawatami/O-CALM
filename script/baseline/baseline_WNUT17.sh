...
python    ../run.py \
          ...
          --data_dir ../data/WNUT17/CLNER_datasets/wnut17_bertscore_eos_doc_full \
          --model BaselineModel \
          ...
          --default_root_dir $INFERENCE_ROOT/logs/Contextual_NER/baseline_large \
          --batch_size  2 \
          --gpus 3 \
          --collector_log_dir $INFERENCE_ROOT/collector/Contextual_NER/baseline_large \
          --ignore_warnings \
          --lr 0.000005 \
          --no_early_stopping \
          --max_epochs 10 \
