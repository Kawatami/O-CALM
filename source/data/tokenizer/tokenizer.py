...
class TokenizerLoader(metaclass=Singleton) :
    ...
    def load_tokenizer(self, tokenizer_class, key : str, **tokenizer_param) :
            ...
            logging.info(f"tokenizer \"{key}\" loaded successfully.")
...
tokenizers = {
    ...
    "RobertaTokenizerFast" : path_tokenizer_ressources / "RobertaTokenizerFast",
    "LayoutLMv2TokenizerFast" : path_tokenizer_ressources / "LayoutLMv2TokenizerFast"
