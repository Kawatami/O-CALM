...
def main() -> int :
    ...
    description = "Augmented NER main training script. Only high level arguments are \
    ...
    high_level_parser.add_argument("--ignore_warnings", action="store_true", default=False,
