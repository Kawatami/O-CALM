...
default_callback = ["EarlyStopping", "ModelCheckpoint", "LearningRateMonitor"]
...
class CallbacksFactory :
    ...
    def __init__(self, args : Namespace) :
        global default_callback #beuuuurk c'est moche mais la flemme de modifier
        ...
        if args.no_early_stopping :
            default_callback = default_callback[1:]
    ...
    def add_callbackFactory_specific_args(parent_parser : ArgumentParser) -> ArgumentParser:
        ...
        group.add_argument("--no_default_callback", action="store_true", default=False)
        group.add_argument("--no_early_stopping", action="store_true", default=False)
